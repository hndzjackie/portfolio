...
function Projects({}: Props) {
  ...
  return (
    <motion.div 
                ...
                items-center justify-center p-20 md:p-44 h-screen">
                    ...
                    <div className="space-y-10 px-0 md:px-10 max-w-6xl-">
                        <h4 className="text-4xl font-semibold text-center">
                            <span className="underline decoration-[#F7AB0A]">Case Study {i+1} of {projects.length}:</span> Show-Time Check-In App
                        </h4>
        ...
        <div className="w-full absolute top:[30%] bg-[rgb(101,137,192)]/10 left-0 h-[500px] 
        -skew-y-12" />
    </motion.div>
  )
}
